...
const props = defineProps({
    ...
    // Posici├│n del icono ('start' o 'end')
    iconPosition: {
...
// Resoluci├│n en cascada inteligente de props (Prop > Contexto > Default)
...
const interactionSound = computed(() => {
    ...
    // Asignamos sonidos del cat├ílogo de Cuelume seg├║n el peso de la variante
